    ...
    {isOpen && (
      ...
      >
        <motion.div
          ...
          onClick={(e) => e.stopPropagation()}
        >
          <h2 className="text-xl font-semibold text-[#ECEFF4] mb-4">Keyboard Shortcuts</h2>
          <div className="space-y-3">
            {[
              { keys: ["⌘/Ctrl", "1-3"], description: "Open applications" },
  ...
  const items = [
    {
      ...
      component: <HostApps />,
      hoverColor: "hover:bg-blue-500/20" // Adjusted for Nord theme
    },
    {
      title: "Statistics",
            ...
            <div className="mb-8 flex items-center justify-between">
              <div>
                ...
                <p className="text-[#D8DEE9]/80 mt-2">
                  Press <kbd className="px-1.5 py-0.5 rounded bg-[#4C566A] text-sm">⌘/Ctrl + K</kbd> to search or{' '}
                  <kbd className="px-1.5 py-0.5 rounded bg-[#4C566A] text-sm">⌘/Ctrl + /</kbd> for shortcuts
                </p>
              </div>
              <motion.button
